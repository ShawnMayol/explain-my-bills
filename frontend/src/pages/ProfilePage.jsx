                ...
                <div className="max-w-4xl mx-auto w-full space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-[#2A2B32] rounded-lg p-6 border border-red-500/20">
                        ...
                        <button
                            ...
                            className="flex items-center gap-3 p-4 bg-red-500/10 rounded-lg border border-red-500/20 hover:bg-red-500/20 transition-colors w-full text-left cursor-pointer"
                        >
