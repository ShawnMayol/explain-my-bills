...
export default function BillDetail() {
  // Get billId from URL params and navigation helpers
  const { billId } = useParams();
  const navigate = useNavigate();
  const { user } = useAuth();

  // State for bill data and images
  ...
  // Fetch bill data from Firestore
  useEffect(() => {
  ...
  // Navigate between images (for multi-page bills)
  ...
  // Delete bill and associated images
    ...
    try {
      ...
      if (billData.publicIds && billData.publicIds.length > 0) {
        for (const publicId of billData.publicIds) {
          await fetch(`${API_URL}/delete-cloudinary`, {
            method: "DELETE",
                ...
                <div className="w-full max-w-6xl">
                    ...
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
                        <div className="flex-shrink-0 w-full lg:w-auto flex flex-col items-center">
                            <div className="relative w-full md:w-[400px]  max-w-[300px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[300px] xl:max-w-[400px] aspect-square bg-zinc-900 border-2 rounded-lg flex items-center justify-center mb-4">
  ...
  // Show error UI if bill not found or failed to load
  if (error) {
    return (
  ...
  // If bill data is not loaded, render nothing
  ...
  return (
      <>
          <div className="flex min-h-screen w-full bg-[#1B1C21] text-white overflow-y-auto overflow-x-hidden relative">
              ...
              {/* Full image modal for multi-page bills */}
              {showImageModal && (
                  <div
                  ...
                  >
                      ...
                      <DialogContent id="delete-dialog-description">
                          <p className="text-sm text-gray-300">
                              ...
                              action cannot be undone, and the bill data will be
...
// InfoItem: displays a label and value for bill details
...
// Card: displays a titled section (e.g., Explanation, Highlights)
